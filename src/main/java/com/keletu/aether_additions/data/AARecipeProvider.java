...
public class AARecipeProvider extends RecipeProvider {
    ...
    private static void crossbow(RecipeOutput output, ItemLike result, ItemLike material, String id) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                ...
                .define('M', material).define('P', Tags.Items.STRINGS)
                .define('T', Items.TRIPWIRE_HOOK).group("aether_crossbows")
                .unlockedBy("has_" + getItemName(material), has(material)).unlockedBy("has_tripwire_hook", has(Items.TRIPWIRE_HOOK))
